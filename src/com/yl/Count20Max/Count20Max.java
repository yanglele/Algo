...
public class Count20Max {
	...
	public static void main(String args[]) throws IOException{  
		  ...
		  BufferedReader buf=new BufferedReader(new FileReader("D:/masterSpring/algo/src/com/yl/Count20Max/english.txt"));  
		 ...
		 // System.out.println(""t 文章中单词总数"+n+"个");  
		  ...
		  BufferedWriter bufw=new BufferedWriter(new FileWriter("D:/masterSpring/algo/src/com/yl/Count20Max/result.txt"));  
